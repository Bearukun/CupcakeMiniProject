            ...
            <div class="createCupcakeContent">
                ...
                <form action="Front" method="POST">
                    ...
                    <div class="col-xs-12" style="padding-top: 20px">
                        ...
                        <input style="max-width: 120px; margin: auto" class="btn btn-success btn-block" type="submit" value="Add Cupcake" name="Login" />
                    </div>
                </form>
            ...
            <div class="chooseCupcakeContent">
                ...
                <form action="Front" method="POST">
                    ...
                    <div class="col-xs-12" style="padding-top: 20px">
                        ...
                        <input style="max-width: 120px; margin: auto" class="btn btn-success btn-block" type="submit" value="Add to basket" name="Login" />
                    </div>
                </form>
            </div>        
        </div>
